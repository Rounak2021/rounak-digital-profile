...
import {BsPersonFillDown} from "react-icons";
                        ...
                        <div class="relative flex items-center justify-end w-1/4 p-1 ml-5 mr-4 sm:mr-0 sm:right-auto">
                            <a href="#" class="relative block">
                                ...
                                <div className="dropdown dropdown-bottom dropdown-end dropdown-hover">
                                    <img alt="profil" src="https://img.icons8.com/pastel-glyph/64/000000/person-male--v3.png" class="mx-auto object-cover rounded-full h-10 w-10 " />
