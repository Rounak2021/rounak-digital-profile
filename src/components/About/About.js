                        ...
                        <div class="relative p-4">
                            <div class="absolute mb-4 text-center transform translate-x-1/2 -top-16 right-1/2">
                                <a href="#" class="relative block">
                                    <img alt="profil" src={selfPP} class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800" />
                                </a>
                            </div>
                            <div class="px-8 py-4 pt-24 bg-white rounded-lg shadow dark:bg-gray-800">
                                <div class="text-center">
                                    ...
                                    <p class="py-4 mx-auto font-light text-gray-500 text-md w-80 dark:text-gray-400">
                                        Hii, myself Rounak from the city of joy, is a budding Developer by proffesion and engineer by pasion. Having more than 7 months of experience in the field of frontend technologies like React Js, HTML, CSS and JS. I am a guy who continously trying to enrich my skillset and trying to upgrade to latest technologies which are running day by day
                                    </p>
                                </div>
                                <div class="flex items-center justify-between w-40 pt-8 mx-auto text-gray-500 border-t border-gray-200">
                                    ...
                                    <a href="https://github.com/Rounak2021">
                        ...
                        <section class="text-gray-600 body-font">
                            <div class="container flex flex-wrap px-5 py-24 mx-auto items-center">
                                <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
                                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Explore my job card over here</h1>
                                    <p class="leading-relaxed text-base">Want to view the entire portfolio of mine? Visit the side panel of this website to explore more. You can also explore my LinkedIn profile from this job card.</p>
                                    <a class="text-indigo-500 inline-flex items-center mt-4">Explore Job Card
                                ...
                                <div class="px-8 py-4 pt-24 overflow-hidden bg-white shadow-lg rounded-xl dark:bg-gray-800">
                                        <div class="flex flex-col items-center justify-between md:flex-row">
                                            <div class="flex items-center justify-start flex-grow w-full">
                                                <a href="#" class="relative block">
                                                    <img alt="profil" src={selfPP} class="mx-auto object-cover rounded-full h-10 w-10 " />
                                                </a>
                                        ...
                                        <p class="mt-4 mb-2 text-lg text-gray-800 dark:text-white">
                                            Working at PwC Kolkata from September 2022 onwards
                                        </p>
                                        <p class="text-sm font-normal text-gray-400">
                                            Current Designation: Developer<br />
                                            Department: Advisory<br />
                                            Technology Used: React JS, HTML, CSS, JS<br />
                                            Technical Stacks: JAVA, JavaScript, C, C++

                                        </p>
                                        <br />
                                        <div class="flex items-start justify-between w-full">
                                            <span class="flex-none px-3 py-1 text-sm text-indigo-500 border border-indigo-500 rounded-full">
                                                Full time
                                            </span>
                                        </div>
                                        <br />
